...
3. Start with a scoped scan: choose a small Google Photos album, or a date range/test batch for another provider, before scanning a large library
4. Review each duplicate group, choose which item or items to keep, and skip any uncertain group
5. Export the JSON or CSV review report before moving anything to provider Trash or Recently Deleted
