...
Provider support, scan limits, and Trash/Restore behavior can vary by service.
Advertised claims for Google Photos, iCloud Photos, or Amazon Photos require
current live Trash/Restore validation evidence.
