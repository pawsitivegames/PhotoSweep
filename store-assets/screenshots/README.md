...
- Do not remove the in-screenshot "Example" labels from seeded review/confirmation states unless those screenshots are replaced with non-seeded real-account captures.
